...
export default function Cover2(props){
...
{(isEditShown && currentDiv==="cover2")?( <button className="btn edit-btn" onClick={showModal}><i class="fas fa-edit"></i></button>):(<div></div>)}
        </div>
        </>
    );
}